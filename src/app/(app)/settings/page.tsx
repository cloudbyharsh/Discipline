...
import { Bell, ShieldCheck, ChevronRight, Layers } from "lucide-react";
...
export default async function SettingsPage() {
  ...
  return (
    <div className="max-w-xl space-y-6">
      ...
      <Card>
        <Link href="/workflows" className="flex items-center justify-between p-5 hover:bg-secondary/50">
